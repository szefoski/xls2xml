...
public class Xls2xml {
	...
	private static void printExample() {
		System.out
				.println("args: [xls input path] [export direcotry] [row of keys start (0 base)] [key column (0 base)] [column of language (0 base):language name]");
		System.out
				.println("example: \"d:/texts.xls\" \"d:/res/texts\" 1 1 \"2:en\" \"3:de\" \"4:fr\"");
		System.out
				.println("example: \"d:/texts.xls\" \"d:/res/texts\" 1 1 \"4:fr\"");
	}
